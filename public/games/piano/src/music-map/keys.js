...
// import audioDataOgg from '../audio/audio.json';
import audioDataMp3 from '../audio/audio-mp3.json';

const audioData = audioDataMp3;

// const audioData = (function xt () {
//     const e = new Audio
//         , t = e.canPlayType('audio/mpeg')
//         , n = e.canPlayType('audio/ogg; codecs="vorbis"');
//     return n === 'probably' ? 'ogg' : t === 'probably' ? 'mp3' : n === 'maybe' ? 'ogg' : 'mp3';
// })() === 'ogg' ? audioDataOgg : audioDataMp3;
...
let newKeyMap = ['', '1----', '1h----', '2----', '1---', '1h---', '2---', '2h---', '3---', '4---', '4h---', '5---', '5h---', '6---', '6h---', '7---', '1--', '1h--', '2--', '2h--', '3--', '4--', '4h--', '5--', '5h--', '6--', '6h--', '7--', '1-', '1h-', '2-', '2h-', '3-', '4-', '4h-', '5-', '5h-', '6-', '6h-', '7-', '1', '1h', '2', '2h',  '3', '4', '4h', '5', '5h', '6', '6h', '7', '1+', '1h+', '2+', '2h+', '3+', '4+', '4h+', '5+', '5h+', '6+', '6h+', '7+', '1++', '1h++', '2++', '2h++', '3++', '4++', '4h++', '5++', '5h++', '6++', '6h++', '7++', '1+++', '1h+++', '2+++', '2h+++', '3+++', '4+++', '4h+++', '5+++', '5h+++', '6+++', '6h+++', '7+++', '1++++'];
